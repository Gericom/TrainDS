...
void TitleMenu::Initialize(int arg)
{
	...
	mButtons[0][0] = mButtons[1][0] = mButtons[2][0] = btn_missions;
	PicturePane* btn_sandbox = (PicturePane*)mLayoutTest->FindPaneByName("btn_sandbox");
	mButtons[0][1] = mButtons[1][1] = mButtons[2][1] = btn_sandbox;
	PicturePane* btn_depot = (PicturePane*)mLayoutTest->FindPaneByName("btn_depot");
	mButtons[0][2] = mButtons[1][2] = mButtons[2][2] = btn_depot;
	mButtons[0][3] = (PicturePane*)mLayoutTest->FindPaneByName("btn_clone");
	mButtons[1][3] = (PicturePane*)mLayoutTest->FindPaneByName("btn_wifi");
	mButtons[1][3]->SetVisible(true);
	mButtons[2][3] = (PicturePane*)mLayoutTest->FindPaneByName("btn_options");
...
void TitleMenu::Render()
{
	...
	else if (mSelectedButton == 3 && mLeftRight == 1 && (gKeys & PAD_BUTTON_A))
